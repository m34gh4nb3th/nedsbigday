                    ...
                    <div key={date}>
                        <Row justify="center" gutter={4}>
                            ...
                            <Col md={{ span: 19 }} xs={{ span: 24}} style={{ paddingLeft: '26px'}}>
                                {date == 7 && (
                                    <a href="/transportation" style={{width: '100%', display: 'flex', alignItems: 'center', marginBottom: '10px', padding: '15px 0px', border: '1px solid #86b59f', borderRadius: '5px', cursor: 'pointer'}}>

                                        <div style={{textAlign: 'center', width: '100%', fontFamily: 'Montserrat', color: '#86b59f', display: 'flex', alignItems: 'center', justifyContent: 'center', '&:hover': {opacity: 0.5}}}>
