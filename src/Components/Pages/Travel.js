        ...
        <div style={style.page}>
            ...
            <Card style={style.card}>
                <Row>
                    ...
                    <Col md={{ span: 16 }} xs={{ span: 24 }} style={{textAlign: 'left'}}>
                        <p>We have coordinated shuttles for day-of transportation between the hotel and the venues. <a href="/transportation" style={{textDecoration: 'underline'}}>Click here for details</a></p>
